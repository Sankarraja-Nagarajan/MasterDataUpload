...
export class VendorMasterDataService {
  ...
  GetEkbeTableData(poNumber): Observable<any> {
    return this._httpService.get(`MasterTable/GetEkbeTableData?poNumber=${poNumber}`);
  }
